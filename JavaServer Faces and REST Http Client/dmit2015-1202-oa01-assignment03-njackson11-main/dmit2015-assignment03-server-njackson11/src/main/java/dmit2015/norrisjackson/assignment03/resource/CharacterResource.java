package dmit2015.norrisjackson.assignment03.resource;
 ...
 *
 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters

 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters/1

 curl -i -X POST http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters  -d '{"name":"Mika","fate":"UNIST","health":1800,"versionAdded":1.3}' -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters/4

 curl -i -X PUT http://localhost:8080/dmit2015-assignment03-server-njackson11/2 -d '{"id":2,"name":"Ruby","fate":"RWBY","health":1800,"versionAdded":1.0}' -H 'Content-Type:application/json'

 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters/2

 curl -i -X GET http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters/3

 curl -i -X DELETE http://localhost:8080/dmit2015-assignment03-server-njackson11/webapi/Characters/3
